...
export default function Permissions() {
  ...
  const columns = [
    { title: 'Yetki Adı', dataIndex: 'name', sorter: true, sortOrder: getSortOrder('name') },
    { title: 'Açıklama', dataIndex: 'description', sorter: true, sortOrder: getSortOrder('description') },
    { title: 'Modül', dataIndex: 'module', sorter: true, sortOrder: getSortOrder('module') },
    { title: 'Aksiyon', dataIndex: 'action', sorter: true, sortOrder: getSortOrder('action') },
    {
      title: 'Durum',
      dataIndex: 'status',
      sorter: true,
