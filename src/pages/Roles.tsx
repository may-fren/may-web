...
export default function Roles() {
  ...
  const rpColumns = [
    { title: 'Yetki Adı', dataIndex: 'permissionName' },
    {
      title: 'Atanma Tarihi',
  ...
  const columns = [
    { title: 'Rol Adı', dataIndex: 'name', sorter: true, sortOrder: getSortOrder('name') },
    ...
    { title: 'Oluşturan', dataIndex: 'createdBy' },
    ...((canUpdate || canDelete) ? [{
      title: 'İşlemler',
      render: (_: unknown, record: Role) => (
        <Space>
          {canUpdate && (
            <Button type="link" icon={<SafetyOutlined />} onClick={() => openPermissionDrawer(record)}>Yetkiler</Button>
          )}
          {canUpdate && (
