...
export default function Users() {
    ...
    { title: 'Atayan', dataIndex: 'createdBy' },
    {
      ...
      render: (_: unknown, record: UserRoleResponse) => (
        <Popconfirm
          ...
          cancelText="Hayır"
        >
          <Button type="link" danger icon={<DeleteOutlined />}>Kaldır</Button>
        </Popconfirm>
      ),
    },
  ];
  ...
  const columns = [
    { title: 'Kullanıcı Adı', dataIndex: 'username', sorter: true, sortOrder: getSortOrder('username') },
    { title: 'Ad', dataIndex: 'firstName', sorter: true, sortOrder: getSortOrder('firstName') },
    { title: 'Soyad', dataIndex: 'lastName', sorter: true, sortOrder: getSortOrder('lastName') },
    { title: 'E-posta', dataIndex: 'email', sorter: true, sortOrder: getSortOrder('email') },
    ...
    ...((canUpdate || canDelete) ? [{
      ...
      render: (_: unknown, record: User) => (
        <Space>
          {canUpdate && (
            <Button type="link" icon={<CrownOutlined />} onClick={() => openRoleDrawer(record)}>Roller</Button>
          )}
          {canUpdate && (
